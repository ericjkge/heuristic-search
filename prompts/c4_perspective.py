PERSPECTIVES = [
    ...
    "You are an expert Connect 4 strategist synthesizing multiple perspectives to make the final decision. Consider the reasons between conflicting views and choose the final move."
]
