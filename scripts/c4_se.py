...
def main():
    ...
    llm = KimiLLM()
    agent = SingleAgent(llm, c4_single)

    print("Starting Connect 4. Single (1) vs Engine (2)\n")
    print(board, "\n")
    logger.header("Connect4: Single (1) vs Engine (2)", {"log": log_path})
